def process_json(
    ...
    async def process_api_requests_from_file(
        ...
        requests = iter(request_json)
        logging.debug(f"File read. Entering main loop")
        ...
        logging.info(
            f"""Parallel processing complete. Results sent to main application"""
        )
